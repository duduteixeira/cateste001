...
var fieldConfigs = [
  {
    "id": "8211f92e-b29d-4ec9-8ed1-3ee309c3839d",
    "type": "text-input",
    "required": false,
    "validation": null,
    "webServices": [],
  ...
  {
    "id": "087323b9-2970-47d7-836d-4e371af7c7cc",
    "type": "textarea",
    "required": false,
    "validation": null,
    "webServices": [],
...
function populateSidebarPanel() {
  ...
  if (schemaFields.length === 0) {
    $list.html('<div class="variable-empty">Nenhuma variável disponível</div>');
    return;
  }
  
  schemaFields.forEach(function(field) {
    var $item = $('<div class="variable-item" title="' + field.key + '">' +
      '<span class="var-icon">⟨⟩</span>' +
      '<span class="var-name">' + field.label + '</span>' +
      '</div>');
    
    $item.data('token', field.token);
    $item.on('click', function() {
      insertVariableFromSidebar(field.token);
    });
